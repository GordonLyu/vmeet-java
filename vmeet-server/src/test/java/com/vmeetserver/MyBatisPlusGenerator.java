...
public class MyBatisPlusGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/vmeet-server/src/main/java");//项目路径
        gc.setAuthor("像风如你");//作者
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/videolink?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8");
